...
int main(){
    ...
    InitAudioDevice();
    Music musicaFaseDeJogo = LoadMusicStream("musicaMenu.mp3");
    SetTargetFPS(60);
...
void desenharMapa(float larguraTotal, float alturaDoMapa){
    DrawLine(larguraTotal/4,0,larguraTotal/4,alturaDoMapa,BLACK);
    DrawLine((larguraTotal*2)/4,0,(larguraTotal*2)/4,alturaDoMapa,BLACK);
    DrawLine((larguraTotal*3)/4,0,(larguraTotal*3)/4,alturaDoMapa,BLACK);
    DrawLine(0,alturaDoMapa/4,larguraTotal,alturaDoMapa/4,BLACK);
    DrawLine(0,(alturaDoMapa*2)/4,larguraTotal,(alturaDoMapa*2)/4,BLACK);
    DrawLine(0,(alturaDoMapa*3)/4,larguraTotal,(alturaDoMapa*3)/4,BLACK);
}
